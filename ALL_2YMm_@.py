...
r_path5 = '/home/caelus/dock_1/Working_hub/DATA_dep/Kuroshio/ALL/task_GRSST/data/' 


data_ghrsst = xr.open_mfdataset(r_path5+'*.nc', parallel=True)



data_ghrsst = data_ghrsst.where(data_ghrsst.mask==1,drop=False)

data_ghrsst = data_ghrsst.fillna(-999)


data_ghrsst_sst = data_ghrsst.analysed_sst

data_ghrsst_sst_a = data_ghrsst_sst - data_ghrsst_sst.mean(dim='time')


WD = 2*12
data_ghrsst_sst_a_2Y = data_ghrsst_sst_a.rolling(time=WD,center=True).mean().dropna("time")
data_ghrsst_sst_a_2Y = data_ghrsst_sst_a_2Y.where(data_ghrsst_sst_a_2Y!=-999,drop=False) 
