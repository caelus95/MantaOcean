...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 13 19:20:15 2021
...
da = xr.Dataset(
    {
        data_name: (["time","s_rho","lat", "lon"], data.values),
    },
    coords={
        "time": t,
...
Data_Mmean.to_netcdf(w_path+data_name+'_s_Mm.nc')

Data_Ymean = da.resample(time="1YS").mean(dim="time")
Data_Ymean.to_netcdf(w_path+data_name+'_s_Ym.nc')
