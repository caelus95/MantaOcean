...
np.save(tmp_path+'u10_stcc',tmp_data1)
np.save(tmp_path+'v10_stcc',tmp_data2)
np.save(tmp_path+'lat_stcc',tmp_data3)
np.save(tmp_path+'lon_stcc',tmp_data4)

curlZ_s = np.load('/home/caelus/dock_1/Working_hub/DATA_dep/tmp/curlZ_stcc.npy') 
...
ADT = xr.open_dataset(r_path3+'adt_18_30_112_180_M.nc')

minlon,maxlon = 112,180
minlat,maxlat = 18,30,
    

ADT_s = ADT.loc[dict(time=slice(Time[0],Time[1]),lat=slice(minlat,maxlat),
