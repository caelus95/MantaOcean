...
r_path = '/home/caelus/dock_1/Working_hub/DATA_dep/Kuroshio/ALL/analysis_sigs/ET_Speed_pc1.npy'

# r_path = '/home/caelus/dock_1/Working_hub/DATA_dep/Kuroshio/first_1_t.npy'
sig = numpy.load(r_path).reshape(-1)

# dat = RM.first_5.values
dat = sig  - numpy.mean(sig) 
