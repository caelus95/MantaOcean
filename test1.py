...
Coef3, p_values3 = linearRegress4Cube(Sig_set.ADT_index_2Y_Rm.dropna()[:-1],adt[12:-12,:,:],['2005-11','2011-01'])
...
plt.title('1994-01 ~ 2018-12',fontsize=38,fontweight='bold')
ax = plt.gca()
...
# plt.suptitle(' 
x, y = m(lon,lat)
m.pcolormesh(x,y,Coef3,cmap=plt.cm.get_cmap('seismic'),shading='gouraud')
plt.clim(-10,10)
